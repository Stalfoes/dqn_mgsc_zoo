#!/bin/bash
#SBATCH --job-name=mgscdqn_batched_reservoir_metasize_100
#SBATCH --output=/home/kapeluck/scratch/dqn_zoo_results/results/mgscdqn_batched_reservoir/alien/metasize_100/out_%A_%a.out
#SBATCH --error=/home/kapeluck/scratch/dqn_zoo_results/results/mgscdqn_batched_reservoir/alien/metasize_100/err_%A_%a.err
#SBATCH --array=0-4
...
python -m dqn_zoo.dqn_mgsc_batched_reservoir.run_atari \
    --seed="${SLURM_ARRAY_TASK_ID}" \
    --environment_name=alien \
    --num_iterations=200 \
    --meta_batch_size=100 \
    --results_csv_path="/home/kapeluck/scratch/dqn_zoo_results/results/mgscdqn_batched_reservoir/alien/metasize_100/seed_${SLURM_ARRAY_TASK_ID}.csv"
