#!/bin/bash
#SBATCH --job-name=mgscdqn_200m_frames
#SBATCH --output=/home/kapeluck/scratch/dqn_zoo_results/results/mgscdqn_200m/jamesbond/mgscdqn_200m_frames_%A_%a.out
#SBATCH --error=/home/kapeluck/scratch/dqn_zoo_results/results/mgscdqn_200m/jamesbond/mgscdqn_200m_frames_%A_%a.err
#SBATCH --array=0-4
