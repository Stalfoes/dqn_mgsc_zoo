...
class MGSCDqn(parts.Agent):
  ...
  def step(self, timestep: dm_env.TimeStep) -> parts.Action:
    ...
    if not (timestep is None):
      ...
      for transition in transitions:
        if self._replay._t % self._nonsense_transition_ratio == 0:
  ...
  def logit_value_stats(self) -> list[tuple[str, Any, str]]:
    return [
      ...
      ('nonsense_entry_avg', self._logits_vs_time['nonsense']['entry']['sum'] / self._logits_vs_time['nonsense']['entry']['num'], '%.3f'),
      ('nonsense_1st_quarter_avg', self._logits_vs_time['nonsense']['1st_quarter']['sum'] / self._logits_vs_time['nonsense']['1st_quarter']['num'], '%.3f'),
      ('nonsense_2nd_quarter_avg', self._logits_vs_time['nonsense']['2nd_quarter']['sum'] / self._logits_vs_time['nonsense']['2nd_quarter']['num'], '%.3f'),
      ('nonsense_3rd_quarter_avg', self._logits_vs_time['nonsense']['3rd_quarter']['sum'] / self._logits_vs_time['nonsense']['3rd_quarter']['num'], '%.3f'),
      ('nonsense_exit_avg', self._logits_vs_time['nonsense']['exit']['sum'] / self._logits_vs_time['nonsense']['exit']['num'], '%.3f'),
      ('real_entry_avg', self._logits_vs_time['real']['entry']['sum'] / self._logits_vs_time['real']['entry']['num'], '%.3f'),
      ('real_1st_quarter_avg', self._logits_vs_time['real']['1st_quarter']['sum'] / self._logits_vs_time['real']['1st_quarter']['num'], '%.3f'),
      ('real_2nd_quarter_avg', self._logits_vs_time['real']['2nd_quarter']['sum'] / self._logits_vs_time['real']['2nd_quarter']['num'], '%.3f'),
      ('real_3rd_quarter_avg', self._logits_vs_time['real']['3rd_quarter']['sum'] / self._logits_vs_time['real']['3rd_quarter']['num'], '%.3f'),
      ('real_exit_avg', self._logits_vs_time['real']['exit']['sum'] / self._logits_vs_time['real']['exit']['num'], '%.3f'),
    ]
