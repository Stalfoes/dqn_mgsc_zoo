...
from dqn_zoo.dqn_mgsc_batched_nonsense_transitions import agent
...
_NONSENSE_TRANSITION_RATIO = flags.DEFINE_integer('nonsense_transition_ratio', int(50), '')
