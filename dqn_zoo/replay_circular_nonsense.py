...
class CircularBuffer(Generic[ItemType]):
  def __init__(self, capacity:int):
    ...
    self._left_head = 0
    self._right_head = 0
    self._is_nonsense = [False] * capacity
  @property
...
class MGSCFiFoTransitionReplay(Generic[ReplayStructure]):
  ...
  def add(self, item: ReplayStructure, nonsense:bool=False) -> None:
    """Adds single item to replay."""
