#!/bin/bash
#SBATCH --job-name=dqn_reservoir_200m_frames
#SBATCH --output=/home/kapeluck/scratch/dqn_zoo_results/results/dqn_reservoir_200m/dqn_reservoir_200m_frames_%A_%a.out
#SBATCH --error=/home/kapeluck/scratch/dqn_zoo_results/results/dqn_reservoir_200m/dqn_reservoir_200m_frames_%A_%a.err
#SBATCH --array=0-4
#SBATCH --time=93:59:59
#SBATCH --mem=25G
#SBATCH --nodes=1
...
python -m dqn_zoo.dqn_reservoir.run_atari \
    --seed="${SLURM_ARRAY_TASK_ID}" \
    --num_iterations=200 \
    --results_csv_path="/home/kapeluck/scratch/dqn_zoo_results/results/dqn_reservoir_200m/seed_${SLURM_ARRAY_TASK_ID}.csv"
